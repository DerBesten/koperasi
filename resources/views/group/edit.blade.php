        ...
        <div class="row row-lg">
          <div class="col-sm-6">
            ...
            <div class="example-wrap" style="width:950px">
              <div class="example">
                <form autocomplete="off" role="form" action="{{ url('group/edit')}}" method="post">
                  {{ csrf_field() }}
                  <input type="hidden" name="id" value="{{ $gr->id }}">
                  <div class="form-group row form-material">
                    <div class="col-sm-6">
                      <label class="control-label" for="inputBasicFirstName">Nama Group</label>
                      <input type="text" class="form-control" id="inputBasicNamaBarang" name="nama"
                      autocomplete="off" value="{{ $gr->nama_group }}"/>
                    </div>
                  </div>
